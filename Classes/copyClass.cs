...
namespace testInstallServer.Classes
{
    ...
    {
        private readonly string preReqRun = @"C:\ProgramData\New World Systems\IMS\Tyler Client Install Service\PreReqs";
        private readonly string nwsAddonLocalRun = @"C:\ProgramData\New World Systems\IMS\Tyler Client Install Service\Addons";
        private readonly string clientRun = @"C:\ProgramData\New World Systems\IMS\Tyler Client Install Service\Clients";
        private bool flag;
